      ...
      <AnimatePresence>
        {open && (
          <motion.div 
            ...
            className="fixed bottom-28 right-6 w-[380px] h-[500px] bg-[#0c0b16]/90 backdrop-blur-2xl border border-white/10 rounded-[28px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-[90] flex flex-col overflow-hidden"
          >
